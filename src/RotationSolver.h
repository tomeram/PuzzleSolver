...
private:
	RotationSolution sol;

	int getPair(int p);
	bool fillRow(int rowSize, int colSize, int row , int col_left , int col_right, RotationSolution sol, TypesMap &typesMap);
	bool topRow(int rowSize, int colSize, int row_top , int col_left , int col_right, RotationSolution sol, TypesMap &typesMap);
	bool bottomRow(int rowSize, int colSize, int row_bott , int col_left , int col_right, RotationSolution sol, TypesMap &typesMap);
